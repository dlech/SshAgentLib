...
namespace dlech.SshAgentLib.WinForms
{
    ...
    public sealed class SecureEdit
    {
        ...
        public uint TextLength
        {
            ...
            {
                if (m_secString != null)
                    return (uint)m_secString.Length;
        ...
        public void Attach(TextBox tbPasswordBox, EventHandler evTextChanged, bool bHidePassword)
        {
            ...
            if (m_evTextChanged != null)
                m_evTextChanged(m_tbPassword, EventArgs.Empty);
        ...
        private void OnPasswordTextChanged(object sender, EventArgs e)
        {
            ...
            if (inxLeft < 0)
                ...
                RemoveInsert(inxLeft, strText.Length - inxRight - 1, sbNewPart.ToString());
        ...
        public byte[] ToUtf8()
        {
            ...
            if (m_secString != null)
            {
                ...
                return Encoding.UTF8.GetBytes(m_strAlternativeSecString);
        }
        ...
        public void SetPassword(byte[] pbUtf8)
        {
            ...
            if (m_secString != null)
            {
                ...
                m_strAlternativeSecString = Encoding.UTF8.GetString(pbUtf8);
